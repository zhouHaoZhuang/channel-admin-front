            ...
            <div class="basicInformation">
              ...
              <div class="basicInformation-item">
                ...
                <span class="basicInformation-info">
                  {{ regionDataEnum[data.regionId] }}
                </span>
              </div>
              <div class="basicInformation-item">
                <span class="basicInformation-type">服务器IP：</span>
                <span class="basicInformation-info"> {{ data.outIp }}</span>
              </div>
              <div class="basicInformation-item">
                <span class="basicInformation-type">内网IP：</span>
                <span class="basicInformation-info">{{ data.innerIp }}</span>
              </div>
              <div class="basicInformation-item">
              ...
              <div class="basicInformation-item">
                ...
                <span class="basicInformation-info"> {{ data.osName }}</span>
              </div>
              <!-- <div class="basicInformation-item">
          ...
          <a-tab-pane key="1" tab="配置信息">
            <div class="basicInformation">
              <div class="basicInformation-item">
                ...
                <span class="basicInformation-info"> {{ data.cpu }}核</span>
              </div>
              <div class="basicInformation-item">
              ...
              <div class="basicInformation-item">
                ...
                <span class="basicInformation-info">
                  {{ data.internetMaxBandwidthOut }}Mbps
                </span>
              </div>
              <div class="basicInformation-item">
          ...
          <a-tab-pane key="1" tab="会员信息">
            <div class="basicInformation">
              ...
              <div class="basicInformation-item">
                ...
                <span class="basicInformation-info"> {{ data.qq }}</span>
              </div>
            </div>
          </a-tab-pane>
        </a-tabs>
